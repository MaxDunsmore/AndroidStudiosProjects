package com.example.mvvmrecyclerviewjava.repositories;
...
public class NicePlaceRepository {
    ...
    private void setNicePlaces(){
        ...
        dataSet.add(
                new NicePlace("https://miro.medium.com/max/1024/1*1BZWu1-RoTcDbzsUngkPfw.jpeg",
                        "Frozen Lake")
        );
        dataSet.add(
